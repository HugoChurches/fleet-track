...
<div class="flex items-center space-x-3 mb-6">
    <p class="text-3xl mb-0">New Administrator</p>
</div>

<form class="max-w-md space-y-3" action="{{route('administrators.store')}}" method="POST" novalidate>
    @csrf
    ...
    <div class="flex justify-end space-x-2">
        ...
        <div class="flex justify-end pt-2">
            <button class="bg-gray-700 text-white rounded px-4 py-2">Add administrator</button>
        </div>
